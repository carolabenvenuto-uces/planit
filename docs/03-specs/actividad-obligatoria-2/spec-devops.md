...
*(Esta sección se completará al momento de realizar los 4 Code Reviews de las PRs del equipo)*

### Decisiones de Diseño en el Mockup
- **Paleta de Colores:** *(Se completará al definir variables en Figma)*
- **Tipografía:** *(Se completará al definir escalas)*
- **Espaciados:** *(Se completará al definir contenedores)*

### Obstáculos Encontrados y Soluciones
- *(Se completará al cerrar la entrega)*
